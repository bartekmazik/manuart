...
const Zone = () => {
  return (
    <div className="flex flex-col justify-center items-center gap-2">
      <div className="relative w-64 h-36 shadow-lg rounded-4xl">
        <Image
          src="/map.jpg"
          alt="map"
          fill
...
const Artist = () => {
  return (
    <div className="flex flex-col sm:flex-row justify-center items-center gap-2">
      <div className="relative sm:w-1/3 h-36 shadow-lg rounded-4xl">
        <Image
          src="/map.jpg"
          alt="map"
          fill
...
const AboutPage = () => {
  return (
    <div className=" flex flex-col pt-12 justify-center sm:justify-start items-start gap-12">
      ...
      <h2 className={`${Gliker.className} text-4xl text-primary`}>
        Strefy wydarzenia
      </h2>
      <div className="grid grid-cols-3 self-center gap-12">
        <Zone />
        <Zone />
