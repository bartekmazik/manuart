...
function Organisator({
  ...
  return (
    <div className="flex min-h-[70vh] flex-col w-full items-center gap-3 bg-background p-4 rounded-2xl shadow-md hover:shadow-lg transition">
      <div className="relative rounded-2xl h-1/2 overflow-hidden  aspect-square w-full  border-4 bg-primary">
        <Image
          src={"/steve.jpg"}
          fill
          alt="organisator"
      ...
      <div className="h-1/2">
        ...
        <h3 className="text-sm text-gray-600 text-center">{role}</h3>
